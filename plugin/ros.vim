...
command! -nargs=1 -complete=custom,ros#RoscdComplete Rosnt :call ros#Rosnt(<f-args>)
command! -nargs=1 -complete=custom,ros#RoscdComplete Rosntcd :call ros#Rosntcd(<f-args>)
